...
func TestNewInMemoryStore(t *testing.T) {
	...
	if diff := cmp.Diff(&inMemoryStore{sessions: make(sessions), mu: sync.RWMutex{}}, got, cmp.AllowUnexported(inMemoryStore{}), cmpopts.IgnoreFields(inMemoryStore{}, "mu")); diff != "" {
