		...
		},
		{
			...
			input: struct {
				...
				envs: map[string]string{
					...
					"BURNIT_DATABASE_CONNECTION_STRING": "mongodb://localhost2:27018",
			...
			want: &Configuration{
				...
				Services: Services{
					...
					Database: Database{
						ConnectionString: "mongodb://localhost2:27018",
		...
		},
		{
			...
			input: struct {
				...
				args: []string{
					...
					"-encryption-key", "key3",
					"-timeout", "25s",
					"-database-connection-string", "mongodb://localhost3:27019",
			...
			want: &Configuration{
				...
				Services: Services{
					...
					Database: Database{
						ConnectionString: "mongodb://localhost3:27019",
